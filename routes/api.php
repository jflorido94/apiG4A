...
Route::prefix('products')->group(function () {
    ...
    Route::post('/{product}/buy', [ProductController::class, 'buy'])->middleware('auth:api');
    // ---- Self only
...
Route::get('manage', [ProductController::class, 'manage'])->middleware('auth:api');
...
Route::prefix('transactions')->group(function () {
    ...
    Route::get('/', [TransactionController::class, 'manage'])->middleware('auth:api');
    Route::post('/{transaction}', [TransactionController::class, 'review'])->middleware('auth:api');
    // --- Self only
